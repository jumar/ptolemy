...
namespace Ptolemy.Tests
{
	...
	public class GPSPointTest
	{
		...
		private static readonly ILog sLogger = log4net.LogManager.GetLogger(typeof(GPSPointTest));
		...
		public void TestConstructor()
		{
			...
			lPoint = new GPSPoint(sGPXInfo.wpt[0]);
			Assert.AreEqual(lLat, lPoint.Lat, "Lat nok");
			Assert.AreEqual(lLng, lPoint.Lng, "Lng nok");
			Assert.AreEqual(lElev, lPoint.Elev, "alt nok");
